...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public static final String TRANSLINK_API_KEY = "y6rdInMxpFdCvrwjnH72";
    ...
    public void onStopSelected(Stop stop) {
        try {StopManager.getInstance().setSelected(stop);}
        catch (StopException e) {System.out.println("Stop is null.");
        }
    }
