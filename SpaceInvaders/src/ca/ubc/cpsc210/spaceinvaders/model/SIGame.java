...
public class SIGame {
	...
	private static final int INVASION_PERIOD = 3;   // on average, one invader each 250 updates
...
//	if we were to use a new object instead of clearing it, the old object would be "garbage collected" and eventually
//  the memory is released so that it can be used elsewhere
